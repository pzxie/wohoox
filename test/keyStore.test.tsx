...
describe('keyStore cache: single component', () => {
  ...
  it('date', () => {
    checkOriginType(new Date(), new Date(Date.now() + 1000000), new Date(Date.now() + 10000));
  });
  ...
  it('object', () => {
    ...
    expect(stringifiedKeySourceMap.size).toBe(currentStringifiedKeySourceMapSize);
    ...
    fireEvent.click(screen.getByRole('update'));
    expect(stringifiedKeySourceMap.size).toBeGreaterThanOrEqual(currentStringifiedKeySourceMapSize);
    ...
    fireEvent.click(screen.getByRole('delete'));
    expect(stringifiedKeySourceMap.size).toBeLessThanOrEqual(currentStringifiedKeySourceMapSize);
